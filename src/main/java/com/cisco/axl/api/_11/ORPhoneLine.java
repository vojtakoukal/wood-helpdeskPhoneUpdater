 ...
 *         &lt;element name="dirn" type="{http://www.cisco.com/AXL/API/11.5}ORDirn" minOccurs="0"/&gt;
 *         &lt;element name="ringSetting" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="consecutiveRingSetting" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="ringSettingIdlePickupAlert" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="ringSettingActivePickupAlert" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="mwlPolicy" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="recordingProfileName" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="monitoringCssName" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="recordingFlag" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="audibleMwi" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="partitionUsage" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="recordingMediaSource" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
