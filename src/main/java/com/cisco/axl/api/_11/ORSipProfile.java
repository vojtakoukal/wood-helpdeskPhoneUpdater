 ...
 *         &lt;element name="userInfo" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="dtmfDbLevel" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="callHoldRingback" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="anonymousCallBlock" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="callerIdBlock" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="dndControl" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="telnetLevel" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="rerouteIncomingRequest" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="resourcePriorityNamespaceListName" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="rsvpOverSip" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="sipRe11XxEnabled" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="gClear" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="sipBandwidthModifier" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="userAgentServerHeaderInfo" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="sipNormalizationScript" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="dialStringInterpretation" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="acceptAudioCodecPreferences" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="resourcePriorityNamespace" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="callingLineIdentification" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="videoCallTrafficClass" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="sdpTransparency" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="sipSessionRefreshMethod" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="earlyOfferSuppVoiceCall" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="cucmVersionInSipHeader" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *         &lt;element name="confidentialAccessLevelHeaders" type="{http://www.cisco.com/AXL/API/11.5}ORFkType" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
