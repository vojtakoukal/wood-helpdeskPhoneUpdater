 ...
 *           &lt;/complexType&gt;
 *         &lt;/element&gt;
 *         &lt;element name="prefixDn" type="{http://www.cisco.com/AXL/API/11.5}String255"/&gt;
 *         &lt;element name="presentationBit" type="{http://www.cisco.com/AXL/API/11.5}XPresentationBit"/&gt;
 *         &lt;element name="silenceSuppressionThreshold" type="{http://www.cisco.com/AXL/API/11.5}XSilenceSuppressionThreshold"/&gt;
 *         &lt;element name="startDialProtocol" type="{http://www.cisco.com/AXL/API/11.5}XStartDialProtocol"/&gt;
 *         &lt;element name="trunk" type="{http://www.cisco.com/AXL/API/11.5}XTrunk"/&gt;
 *         &lt;element name="trunkDirection" type="{http://www.cisco.com/AXL/API/11.5}XTrunkDirection"/&gt;
 *         &lt;element name="trunkLevel" type="{http://www.cisco.com/AXL/API/11.5}XTrunkLevel"/&gt;
 *         &lt;element name="trunkPadRx" type="{http://www.cisco.com/AXL/API/11.5}XTrunkPad"/&gt;
 *         &lt;element name="trunkPadTx" type="{http://www.cisco.com/AXL/API/11.5}XTrunkPad"/&gt;
 *         &lt;element name="vendorConfig" type="{http://www.cisco.com/AXL/API/11.5}XVendorConfig" minOccurs="0"/&gt;
 *         &lt;element name="callerId" type="{http://www.cisco.com/AXL/API/11.5}XCallerID"/&gt;
